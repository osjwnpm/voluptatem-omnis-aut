[![Latest version](https://img.shields.io/npm/v/@osjwnpm/voluptatem-omnis-aut.svg)](https://www.npmjs.com/package/@osjwnpm/voluptatem-omnis-aut)

# `@osjwnpm/voluptatem-omnis-aut`
...
```bash
npm install @osjwnpm/voluptatem-omnis-aut
```
...
```js
import { ClientRequestInterceptor } from '@osjwnpm/voluptatem-omnis-aut/ClientRequest'
...
```js
import { BatchInterceptor } from '@osjwnpm/voluptatem-omnis-aut'
import { ClientRequestInterceptor } from '@osjwnpm/voluptatem-omnis-aut/ClientRequest'
import { XMLHttpRequestInterceptor } from '@osjwnpm/voluptatem-omnis-aut/XMLHttpRequest'
...
```js
import { BatchInterceptor } from '@osjwnpm/voluptatem-omnis-aut'
import nodeInterceptors from '@osjwnpm/voluptatem-omnis-aut/presets/node'
...
```js
import { BatchInterceptor } from '@osjwnpm/voluptatem-omnis-aut'
import browserInterceptors from '@osjwnpm/voluptatem-omnis-aut/presets/browser'
...
```js
import { WebSocketInterceptor } from '@osjwnpm/voluptatem-omnis-aut/WebSocket'
...
```js
// child.js
import { RemoteHttpInterceptor } from '@osjwnpm/voluptatem-omnis-aut/RemoteHttpInterceptor'
import { ClientRequestInterceptor } from '@osjwnpm/voluptatem-omnis-aut/ClientRequest'
...
import { RemoteHttpResolver } from '@osjwnpm/voluptatem-omnis-aut/RemoteHttpInterceptor'
